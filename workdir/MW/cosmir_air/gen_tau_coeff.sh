...
#      echo "#SBATCH --account=star" >> ${jobScript}
      ...
      echo "#SBATCH --output=/data/users/bjohnson/CRTM/tmp3/CRTM_coef/workdir/MW/cosmir_air/control/output.%j.txt" >> ${jobScript}
      echo "#SBATCH --error=/data/users/bjohnson/CRTM/tmp3/CRTM_coef/workdir/MW/cosmir_air/control/output.%j.err" >> ${jobScript}
