...
MODULE ECMWF5K_Parameters
  ...
  '$Id: ECMWF5K_Parameters.f90 20753 2012-08-24 18:40:01Z paul.vandelst@noaa.gov $'

  ! ASCII data file info
  CHARACTER(*), PARAMETER :: ECMWF5K_ASCII_FILE = 'nwp_saf_t_sampled.atm'
  !JR Changed blank "x" to "1x" due to gfortran complaints
  CHARACTER(*), PARAMETER :: ECMWF5K_FMT_STRING = '(833(e13.6,1x),i5,3i3,i7,i5)'
