...
MODULE CrIS_Define
  ...
  '$Id: CrIS_Define.f90 34085 2013-11-25 14:11:19Z paul.vandelst@noaa.gov $'
  ...
  ! ...Frequencies
  REAL(fp), PUBLIC, PARAMETER :: CRIS_BAND_F1(N_CRIS_BANDS) = (/  650.00_fp, 1210.00_fp, 2155.0_fp /)
  REAL(fp), PUBLIC, PARAMETER :: CRIS_BAND_F2(N_CRIS_BANDS) = (/ 1095.00_fp, 1750.00_fp, 2550.0_fp /)
  ! ...Channel numbering
  ...
  REAL(fp), PUBLIC, PARAMETER :: CRIS_MIN_FREQUENCY = 650.0_fp
  REAL(fp), PUBLIC, PARAMETER :: CRIS_MAX_FREQUENCY = 2550.0_fp
  REAL(fp), PUBLIC, PARAMETER :: CRIS_D_FREQUENCY(N_CRIS_BANDS) = (/ 0.625_fp, 1.25_fp, 2.5_fp /)
  REAL(fp), PUBLIC, PARAMETER :: CRIS_RESAMPLE_MAXX(N_CRIS_BANDS)   = (/ 0.8_fp  , 0.4_fp , 0.2_fp /)
