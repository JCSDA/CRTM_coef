...
MODULE IASI_Define
  ...
  '$Id: IASI_Define.f90 15180 2011-08-26 20:27:11Z paul.vandelst@noaa.gov $'
  ! Literal constants
  ...
  ! ...Frequencies
  REAL(fp), PUBLIC, PARAMETER :: IASI_BAND_F1(N_IASI_BANDS) = (/  645.00_fp, 1210.00_fp, 2000.0_fp /)
  REAL(fp), PUBLIC, PARAMETER :: IASI_BAND_F2(N_IASI_BANDS) = (/ 1209.75_fp, 1999.75_fp, 2760.0_fp /)
  ! ...Channel numbering
  ...
  REAL(fp), PUBLIC, PARAMETER :: IASI_MIN_FREQUENCY = 645.0_fp
  REAL(fp), PUBLIC, PARAMETER :: IASI_MAX_FREQUENCY = 2760.0_fp
  REAL(fp), PUBLIC, PARAMETER :: IASI_D_FREQUENCY(N_IASI_BANDS)    = 0.25_fp
  REAL(fp), PUBLIC, PARAMETER :: IASI_RESAMPLE_MAXX(N_IASI_BANDS) = TWO
