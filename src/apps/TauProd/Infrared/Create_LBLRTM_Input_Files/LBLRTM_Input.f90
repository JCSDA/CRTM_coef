...
!    END IF
    ...
    xsection_option: IF ( user_calculation_flags%xsection == 1 ) THEN
      ...
      xsection_user_profile: IF ( PRESENT( xsection_pressure ) .AND. &
        ...
        ! -- Check contents
        IF ( ANY( xsection_units /= 'A' ) .AND. ANY( xsection_units /= '1' ) ) THEN
          error_status = FAILURE
          CALL display_message( ROUTINE_NAME, &
...
!================================================================================
  ...
  FUNCTION Write_Record_3p1( file_id,       &  ! Input
    ...
    WRITE( file_id, FMT    = '( 7( i5 ), i2, 1x, i2, 4( f10.3 ) )', &
...
!-------------------------------------------------------------------------------
!
! $Id: LBLRTM_Input.f90 4434 2009-07-30 13:58:26Z paul.vandelst@noaa.gov $
!
