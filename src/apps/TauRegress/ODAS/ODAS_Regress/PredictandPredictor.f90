...
module PredictandPredictor
 ...
 contains
  ...
  !   Logarithm of absorption coefficient is introduced as
  !   predictand
  !
  !                   d ln Trans
  !     ln k = ln ( - ---------- )
  ...
  !
  !   On discrete space, it is modified by
  !
  ...
  !   In such case, predictands are estimated extrapolating toward
  !   top and bottom.
  ...
  subroutine Get_Predictand( trans_lev,     &
    ...
    do Iang = 1, Nangle
      ...
      call Get_Predictand_Profile( trans_lev     (:,Iang,Iatm), &
                                   absamount_lev (:,Iang,Iatm), &
                                   predictand_lay(:,Iang,Iatm)  )
    enddo
    enddo
...
!      print *, 'predictand_lay:', predictand_lay(Ilev)
    ...
    !--- extrapolate predictands toward top
    ...
    !--- extrapolate predictands toward bottom
