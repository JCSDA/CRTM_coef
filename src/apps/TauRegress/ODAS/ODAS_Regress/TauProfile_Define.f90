...
MODULE TauProfile_Define
  ...
  '$Id: TauProfile_Define.f90 3891 2009-05-29 15:09:16Z yong.chen@noaa.gov $'
  ! Keyword set value
...
!------------------------------------------------------------------------------
  ...
  FUNCTION Allocate_TauProfile( n_Layers       , &  ! Input
    ...
    IF ( n_Layers        < 1 .OR. &
      ...
      Error_Status = FAILURE
      WRITE(*,*) 'Layers, Channels, Angles, Profiles, Molecule Sets: ', n_Layers, n_Channels, n_Angles, n_Profiles, n_Molecule_Sets
      CALL Display_Message( ROUTINE_NAME, &
