...
# $Id: run_Create_SpcCoeff.sh 43012 2014-07-15 17:12:11Z paul.vandelst@noaa.gov $

script_id()
{
  REVISION='$Revision: 43012 $'
  LAST_CHANGED_DATE='$LastChangedDate: 2014-07-15 17:12:11 +0000 (Tue, 15 Jul 2014) $'
  echo
