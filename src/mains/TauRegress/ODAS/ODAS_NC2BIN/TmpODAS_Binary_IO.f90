...
MODULE TmpODAS_Binary_IO
  ...
  USE TmpODAS_Define,     ONLY: TauCoeff_Type, &
                                 N_TAUCOEFF_ITEMS, &
                                 TAUCOEFF_DATA_TYPE, &
                                 TAUCOEFF_DATA_NAME, &
                                 Associated_TauCoeff, &
  ...
  CHARACTER(*), PARAMETER :: MODULE_RCS_ID = &
    '$Id: TmpODAS_Binary_IO.f90 5115 2009-10-01 19:19:20Z paul.vandelst@noaa.gov $'
