...
! =====           =======              ============
! 2021-02-27      Patrick Stegmann     Restored functionality.
!
...
MODULE TauProfile_netCDF_IO
  ...
  CHARACTER(*), PARAMETER :: MODULE_RCS_ID = &
    '$Id: TauProfile_netCDF_IO.f90 734 2021-02-27 13:31:20Z patrick.stegmann@noaa.gov $'
  ! Keyword set value
...
!------------------------------------------------------------------------------
 ...
 FUNCTION Write_GeometricAngle_netCDF( NC_Filename , &  ! Input
    ...
    !Error_Status = NF90_CREATE(PATH=TRIM(NC_Filename), CMODE=NF90_CLOBBER, NCID=NC_FileID)
    !ierr = nf90_def_var(NC_FileID, 'Array',  NF90_REAL, arrdims, array_id)
    !Error_Status = NF90_ENDDEF(NC_FileID)
    IF ( Error_Status /= SUCCESS ) THEN
      Message = 'Error defining netCDF Geometric_Angle variable '//&
                TRIM(NC_Filename)
      GOTO 2000
    END IF
