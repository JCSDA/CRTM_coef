...
!
!       Modified by:    Isaac Moradi 09-Nov-2018
!                       Isaac.Moradi@NASA.GOV
!                       Fixed the calcualtions for unit conversions
!
...
MODULE Spectral_Units_Conversion
  ...
  '$Id: Spectral_Units_Conversion.f90 14334 2011-06-21 13:43:46Z paul.vandelst@noaa.gov $'
