...
PROGRAM Convolve_TauSpc_with_SRF
  ...
  '$Id: Convolve_TauSpc_with_SRF.f90 5182 2009-10-13 14:57:44Z yong.chen@noaa.gov $'
...
print*, ProcessControl%TauProfile_Filename(n)
...
print*, "reading ", Tau_Filename(Band_Index(lBand))       
        Error_Status = LBLRTM_netCDF_ReadFile(ofile,Tau_Filename(Band_Index(lBand)) )
        ! End of code changed by Isaac
...
!                                              Comment = History )
      ...
      SRF_Read: DO lch = 1, n_Channels_to_Process
        ...
        ! Read the data
print*, "reading SRF ", ProcessControl%SRF_Filename(n)
      ...
      Process_Layer: DO k = 1, N_LAYERS
        ...
        Band_File_Read: DO lBand = 1, n_Available_Bands
          ...
          ! Added by Isaac Moradi
          Transmittance(l1:l2) = ofile%Layer(k)%Spectrum(:,1)
          ! End of code added by Isaac
