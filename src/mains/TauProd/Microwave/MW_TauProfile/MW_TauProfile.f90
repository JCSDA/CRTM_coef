...
!       Updated by:     Patrick Stegmann, 13-Jan-2021
...
PROGRAM MW_TauProfile
  ...
  CHARACTER(*), PARAMETER :: PROGRAM_VERSION_ID = &
    '$Id: MW_TauProfile.f90 45710 2021-05-31 13:00:00Z patrick.stegmann@noaa.gov $'
  ...
  Sensor_Loop: DO n = 1, n_sensors
    ...
    WRITE(*,*) "Sensor Type: ", sinfo%Sensor_Type, MICROWAVE_SENSOR
