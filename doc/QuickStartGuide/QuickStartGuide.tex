...
echo "#SBATCH --output=<path>/CRTM_coef/workdir/MW/cosmir_air/control/output.%j.txt" >> ${jobScript}
echo "#SBATCH --error=<path>/CRTM_coef/workdir/MW/cosmir_air/control/output.%j.err" >> ${jobScript}
