...
#      echo "#SBATCH --account=star" >> ${jobScript}
      ...
      echo "#SBATCH --output=/scratch/users/pstegmann/GenCoeff/control/output.%j.txt" >> ${jobScript}
      echo "#SBATCH --error=/scratch/users/pstegmann/GenCoeff/control/output.%j.err" >> ${jobScript}
      ...
      echo "srun ${EXE_FILE} 2" >> ${jobScript}
